...
This increased purity, along with growing the crystals from powder, strongly reduces bulk contaminations of $^{40}$K, which is a particularly problematic background for \twonubb~measurements, as it decays through beta-decay and has a similar spectral shape to \twonubb~decays.
...
Despite the short $\sim$1 month that the crystals are aboveground, this exposure to cosmic rays causes the crystals to have cosmogenic activation of $^{110m}$Ag and $^{60}$Co that contribute $<1\%$ of the background at the Q-value of $^{130}$Te \cite{PhysRevC.92.024620, BARGHOUTY201316}.
...
What makes exposure to air particularly worrisome, is that Radon present in air will radioactively contaminate the towers.
In order to complete this activity while minimizing the contact of Radon in air, a specialized clean room was installed around the exposed inner part of the cryostat.
In addition, this room was equipped with a radon abatement system that flushed the room with Radon-free air, taking the activity of Radon in the air from the 80 $\textrm{Bq}/\textrm{m}^3$ \cite{UndergroundLabs_Radon} at LNGS down to $<1~\textrm{Bq}/\textrm{m}^3$ inside the clean room.
...
Of course, as shown in \autoref{eq:sensitivity_short}, the detector mass is only one part of the sensitivity equation, but successive experiments have also significantly reduced backgrounds and other improvements to increase sensitivity beyond merely gaining from increased mass.
As a full description and history of the CUORE-like experiments is too long for discussion here, the most recent experiments, namely Cuoricino and CUORE-0, that directly inform choices made for CUORE are described below.
...
This improvement is quantified in \autoref{fig:cuore-0_vs_cuoricino} where a significant decrease is observed in the $\alpha$ backgrounds due to components nearest to the crystals.
...
This $\approx70$ tonne, 25 cm thick lead shielding acts to shield the interior of the cryostat from the environmental gammas from LNGS, and the 18 cm thick polyethylene and 2 cm thick boric acid (H$_3$BO$_3$ powder) shields thermalize and absorb environmental neutrons.
...
In fact, even despite all these components, we set bad intervals, described more in \autoref{ssec:Bad Intervals} during particularly intense seismic events around the globe.
...
In order to minimize the radioactivity of these components, with over 7 tonnes of mass, these plates and vessels are made of Oxygen-Free Electronic (OFE) copper (99.99\% Cu). However, the 300-K plate and the top of the 300-K vessel are made of stronger austenitic stainless steel due to the load they carry.
