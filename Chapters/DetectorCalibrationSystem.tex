...
\includegraphics[height=2.2in]{source_capsule_schematic.pdf}\label{fig:source_carrierA}
\caption{}
\end{subfigure}
\begin{subfigure}[b]{0.15\textwidth}
\includegraphics[height=2.7in]{string_bottom.pdf}\label{fig:source_carrierB}
\caption{}
\end{subfigure}
\end{center}
